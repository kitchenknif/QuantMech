\section{Analytical Solutions}
	\subsection{Rectangular quantum well}
		...
		\subsubsection{Bound states}
			...
			\paragraph{Symmetric solutions}
				...
				\begin{figure}[!h]
					\centering
					\input{figs/analytic/symsoleq.tex}
			...
			\begin{figure}[!h]
				\centering
				\input{figs/analytic/boundstates.tex}
	...
	\begin{figure}[!h]
		\centering
		\input{figs/analytic/angmomentum.tex}
	...
	\begin{figure}[!h]
		\centering
		\input{figs/analytic/spherecoord.tex}
	...
	\subsection{Problems}
		\subsubsection{Rectangular quantum well}
			...
			\paragraph{Double quantum barrier}
				\begin{figure}[!h]
					\centering
					\input{figs/doublequantumbarrier.tex}
